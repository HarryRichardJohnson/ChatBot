...
class TestBotClass(unittest.TestCase):
    ...
    def test_bot_response(self):
        userQuestion = self.bot.chatterbot.get_response("What are the prerequisites for the Computer Graphics Paper?")
        self.assertEqual(userQuestion, "Pre-requisite: MATH502 Algebra and Discrete Mathematics, COMP603 Program Design and Construction or COMP610 Data Structures and Algorithms")
